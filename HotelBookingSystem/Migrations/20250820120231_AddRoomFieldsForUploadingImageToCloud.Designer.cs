...
namespace HotelBookingSystem.Migrations
{
    ...
    [Migration("20250820120231_AddRoomFieldsForUploadingImageToCloud")]
    partial class AddRoomFieldsForUploadingImageToCloud
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelBookingSystem.Models.BookingStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelBookingSystem.Models.PaymentStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelBookingSystem.Models.Booking", b =>
                {
                    b.HasOne("HotelBookingSystem.Models.BookingStatus", "BookingStatus")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("HotelBookingSystem.Models.Payment", b =>
                {
                    ...
                    b.HasOne("HotelBookingSystem.Models.PaymentStatus", "PaymentStatus")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("HotelBookingSystem.Models.Review", b =>
                {
                    b.HasOne("HotelBookingSystem.Models.Booking", "Booking")
                        .WithOne("Review")
                        .HasForeignKey("HotelBookingSystem.Models.Review", "BookingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
